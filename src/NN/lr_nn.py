...
reg = MLPRegressor(hidden_layer_sizes=(int(28.249276425158556), int(12.539980271143648), int(6.2172389369312375)))#,tol=1e-6,max_iter=1000, verbose=True)#, len(X_names)-2))
