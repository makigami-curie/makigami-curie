...
#		print(col, len(dataset[col].unique()) , CUTOFF * N, len(dataset[col].unique()) > CUTOFF * N )
		if len(dataset[col].unique()) > CUTOFF * N : skip_columns.append(dataset.columns.get_loc(col))
